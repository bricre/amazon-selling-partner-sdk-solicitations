# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Solicitations
...
```shell
composer require bricre/amazon-selling-partner-sdk-solicitations
```
